        ...
        <div v-if="gamesList != null && gamesList.length > 0" class="mt-4">
            <div class="w-full bg-white text-sm text-left cursor-pointer rounded-md shadow-md">
                <div
                    ...
                    <div class="text-center px-3 py-1 md:w-1/12">
                        #
                    </div>

                    <div class="px-3 py-1 md:w-2/12">
                        Game
                    </div>
                    ...
                    <div class="px-3 py-1 md:w-1/12 items-center flex justify-center">
                        Stop
                    </div>
                ...
                <div v-for="(game, index) in gamesList"
                    ...
                    <div class="hidden md:block text-center px-3 py-1 md:w-1/12">
                        {{ index + 1 }}
                    </div>
                    ...
                    <div class="md:w-2/12 flex m-1 md:m-0 rounded-md border md:border-none">
                        <div
                            @click="stopGame(game)"
                            class="w-1/2 px-3 py-1 rounded-l-md md:rounded-none bg-blue-500 text-gray-200 md:text-inherit md:bg-inherit items-center flex justify-center hover:text-gray-800 md:hover:text-blue-500 uppercase">
                        ...
                        <div
                            ...
                            class="w-1/2 px-3 py-1 rounded-r-md md:rounded-none bg-gray-800 text-gray-200 md:text-inherit md:bg-inherit items-center flex justify-center hover:text-red-500 uppercase">
...
export default {
    ...
    methods: {
        ...
        stopGame(game) {
            if (game.stopped_at === null) {
                this.$inertia.get('/orders/stop-game/' + game.id);
            }
        }
    }
}
