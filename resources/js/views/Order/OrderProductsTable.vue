    ...
    <div v-if="productsList != null && productsList.length > 0">
        <div class="w-full bg-white text-sm text-left cursor-pointer rounded-md shadow-md">
            <div
                ...
                <div class="px-3 py-1 md:w-4/12">
                    Title
                </div>

                <div class="px-3 py-1 md:w-3/12">
                    Count
                </div>
            ...
            <div v-for="(order, index) in productsList"
                ...
                <div class="hidden md:block text-center px-3 py-1 md:w-1/12 lg:w-1/12">
                    {{ index + 1 }}
                </div>
                ...
                <div class="px-3 py-1 md:px-0 md:py-0 md:w-1/12">

                    <div
                        @click="confirmDelete(order)"
                        class="w-full px-3 py-1 rounded-md md:rounded-none bg-gray-800 text-gray-200 md:text-inherit md:bg-inherit items-center flex justify-center hover:text-red-500 uppercase">
