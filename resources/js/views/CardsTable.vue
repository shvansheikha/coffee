<template>
    <div>
        <div class="w-full md:bg-white text-sm text-left cursor-pointer md:rounded-md md:shadow-md">
            <div
            ...
            <div v-for="(card, index) in cardsList"
                ...
                <div class="px-3 py-3 w-full md:w-3/12">
                    <Link :href="'/orders/'+card.basket.id">
                        <div
                ...
                <div class="md:w-4/12 flex m-2 md:m-0 rounded-md border md:border-none">
                    ...
                    <div
                        ...
                        class="w-1/2 px-3 py-2 rounded-r-md md:rounded-none bg-gray-800 text-gray-200 md:text-inherit md:bg-inherit items-center flex justify-center hover:text-red-500 uppercase">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                             viewBox="0 0 24 24"
                             stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
...
export default {
    ...
    methods: {
        ...
        updateCard(id) {
            this.$inertia.put('/cards/' + id, this.form, {
                preserveState: false,
                onSuccess: () => {
                    this.form.id = null;
