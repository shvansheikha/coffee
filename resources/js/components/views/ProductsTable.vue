<template>
    <div>
        <table class="w-full text-sm text-left text-gray-500 cursor-pointer shadow rounded">
            ...
            <tr v-for="(product, index) in productsList" class="bg-white border-b hover:bg-gray-50">
                ...
                <td class="px-6 py-3">
                    <div @click="updateForm(product)" class="hover:text-blue-500 uppercase">
                        edite
                    </div>
                </td>

                <td class="px-6 py-4">
                    <div @click="confirmDelete(product)" class="hover:text-blue-500">
                        Delete
                    </div>
                </td>
            </tr>
