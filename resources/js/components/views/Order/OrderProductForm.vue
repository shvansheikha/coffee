    ...
    <div class="p-4">
        ...
        <div class="md:flex items-center pb-2 mb-2">
            ...
            <input type="text"
                   ...
                   class="mb-2 md:mb-0 mr-4 form-control block w-full md:w-1/6 px-3 py-1 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-400 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white hover:border-blue-600 focus:border-blue-600 focus:outline-none"
                   placeholder="Number">

            <div @click="submitOrder"
                 class="mb-2 md:mb-0 w-full md:w-1/6 text-center border border-current hover:border-blue-500 transition-all duration-300 ease-in-out cursor-pointer hover:text-blue-500 rounded px-4 py-1">
                Order
            </div>
        </div>
    </div>
